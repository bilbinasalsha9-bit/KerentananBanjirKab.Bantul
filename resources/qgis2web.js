...
map.getView().fit([12265986.477578, -897397.392700, 12305849.792166, -866592.649200], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">KerentananBanjirKab.Bantul</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (11 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '(Ringkasan)';
            }
